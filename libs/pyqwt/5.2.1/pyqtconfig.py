...
_pkg_config = {
    'pyqt_bin_dir':      os.environ['PYQTBIN'],
    'pyqt_config_args':  '--destdir ' + os.environ['PYQTPYTHON'] + ' --bindir ' + os.environ['PYQTBIN'] + ' --sipdir ' + os.environ['PYQTDIR'] + '/share/sip --confirm-license --no-designer-plugin',
    'pyqt_mod_dir':      os.environ['PYQTPYTHON'] + '/PyQt4',
    'pyqt_modules':      'QtCore QtNetwork QtScript QtXml QtXmlPatterns',
    'pyqt_sip_dir':      os.environ['PYQTDIR'] + '/share/sip',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_SessionManager -x PyQt_NoPrintRangeBug -t Qt_4_8_4 -x Py_v3 -g',
    'pyqt_version':      0x040b02,
    'pyqt_version_str':  '4.11.2',
    'qt_archdata_dir':   os.environ['QTDIR'],
    'qt_data_dir':       os.environ['QTDIR'],
    'qt_dir':            os.environ['QTDIR'],
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        os.environ['QTINCLUDE'],
    'qt_lib_dir':        os.environ['QTLIB'],
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                os.environ['QTINCLUDE'],
